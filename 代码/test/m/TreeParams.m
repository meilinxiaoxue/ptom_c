...
%       PredictorSelection - Algorithm for predictor selection for splits
...
%       UseChisqTest       - Use chi-square test for curvature tests.
...
%   Copyright 2010-2017 The MathWorks, Inc.
    ...
    methods(Static,Hidden)
        ...
        function this = loadobj(obj)
            ...
            if ismember('Version',found) && ~isempty(obj.Version)
                if     obj.Version==classreg.learning.modelparams.TreeParams.expectedVersion()                
                    % If object of the same version, copy all params as is.
                    this = obj;
                    
                elseif obj.Version==1
                    % Predictor selection was added to version 2
    ...
    methods(Hidden)
        function this = fillDefaultParams(this,X,Y,W,dataSummary,classSummary) %#ok<INUSD>
            ...
            elseif islogical(this.NSurrogate) && this.NSurrogate
                this.NSurrogate = min(D-1,10);
            ...
            if isempty(this.PredictorSelection)
                this.PredictorSelection = 'allsplits';
            end
            
            if isempty(this.UseChisqTest)
