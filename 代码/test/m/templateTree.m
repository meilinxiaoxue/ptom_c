...
%       'PredictorSelection'      - Character vector specifying the
%                                   algorithm for choosing the best split
%                                   predictor, one of: 'allsplits',
%                                   'curvature' and
%                                   'interaction-curvature'. If
%                                   'allsplits', the split predictor is
%                                   chosen by maximizing the gain in the
%                                   split criterion over all possible
%                                   splits on all predictors. If
%                                   'curvature', the split predictor is
%                                   chosen by minimizing the p-value of a
%                                   chi-square test of independence between
%                                   each predictor and response. If
%                                   'interaction-curvature', the split
%                                   predictor is chosen by minimizing the
%                                   p-value of a chi-square test of
%                                   independence between each predictor and
%                                   response and minimizing the p-value of
%                                   a chi-square test of independence
%                                   between each pair of predictors and
%                                   response. Default: 'allsplits'
...
%                                   Default for ECOC: 'on'
%       'PruneCriterion'          - Character vector with the pruning
%                                   criterion, 'error' or 'impurity' for
