classdef ExponentialARD < classreg.learning.gputils.Kernel
%ExponentialARD A class that defines the Exponential kernel with a separate length scale per predictor.
%
%   ExponentialARD properties:
...
%   Copyright 2014-2016 The MathWorks, Inc.
    ...
    properties(Constant)
        ...
        Name = classreg.learning.modelparams.GPParams.ExponentialARD;              
    end
    ...
    properties(GetAccess=public,SetAccess=protected)
        ...
        %   function. The ExponentialARD kernel can be parameterized
        ...
        %   Does not apply to the ExponentialARD kernel.
        CustomFcn = [];          
    end
    ...
    methods(Access=protected)
        function this = ExponentialARD()            
        end        
    end
    methods(Static)        
        function this = makeFromTheta(theta)
        %makeFromTheta - Make ExponentialARD kernel function.
        %   this = makeFromTheta(Theta) takes a (d+1)-by-1 vector Theta
        %   where d is the number of predictors and returns an
        %   ExponentialARD kernel object. Theta is related to length
        ...
        %       Theta(d+1) = log(sigmaF)
            ...
            this               = classreg.learning.gputils.ExponentialARD();
            this.Theta         = theta;
    ...
    methods      
        ...
        %
        %   As an example, for ExponentialARD with 2 predictors,
    ...
    methods
        ...
        %   KNM and DKNM at a higher memory cost.        
            ...
            % Force D2 to be >= 0 for the ExponentialARD kernel.
        ...
        %   o KNM = N-by-M kernel matrix K(XN,XM | Theta).        
            ...
            % calcDistance to be >= 0 for the ExponentialARD kernel.
            d        = length(theta) - 1;            
            sigmaL   = exp(theta(1:d));
            sigmaF   = exp(theta(d+1));            
            tiny     = this.Tiny;
