...
%Exponential A class that defines the exponential kernel.
%
...
%   Copyright 2014-2016 The MathWorks, Inc.
    ...
    properties(GetAccess=public,SetAccess=protected)
        ...
        %   function. The Exponential kernel can be parameterized in
        ...
        %   Does not apply to the Exponential kernel.
        CustomFcn = [];                
    end
    ...
    methods(Static)        
        ...
        %makeFromTheta - Make Exponential kernel function.
        %   this = makeFromTheta(Theta) takes a 2-by-1 vector Theta and
        %   returns an Exponential kernel object. Theta is related to
    ...
    methods      
        ...
        %
        %   For exponential kernel params struct has these fields:
        %
        %       Name                 = 'Exponential'
    ...
    methods
        ...
        %   KNM and DKNM at a higher memory cost.        
            ...
            if usecache
                ...
                % take the square root for Exponential evaluation.
        ...
        %   o KNM = N-by-M kernel matrix K(XN,XM | Theta).        
            ...
            function KNM = f(XN,XM)                
                % 2.1 Compute D/sigmaL where D is the Euclidean distance matrix.
