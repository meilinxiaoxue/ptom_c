...
%   Copyright 2014-2015 The MathWorks, Inc.
    ...
    methods
        ...
        %   observations in OBJ.X and L binary learners in the BinaryLearners
        %   properties of the OBJ.Trained folds. If the coding matrix varies across
        %   the folds, KFOLDPREDICT returns PBSCORE as an empty array.
        %
        ...
        %                                you pass a function handle FUN,
        %                                KFOLDPREDICT calls it as shown below:
        %                                      FUN(M,F)
