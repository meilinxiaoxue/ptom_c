            ...
            for l=1:length(templates)
                ...
                if any(ismember(this.Method,{'LogitBoost' 'GentleBoost'}))
                    ...
                    if strcmp(learner.Method,'ByBinaryRegr')
                        % Make sure predictor names and categorical indices
                        % are passed to the underlying regression learner.
                        % The ByBinaryRegr template gets those set like
                        % every other template later.
                        ...
                        % If this is not a ByBinaryRegr template, make one
                        % from scratch.
                ...
                % Make sure there is a message about every fold being
                % processed when ECOC verbosity is set
                if ismember(this.Method,{'PartitionedECOC' 'PartitionedLinearECOC'}) ...
                ...
                if strcmp(this.Type,'classification') && ~strcmp(learner.Method,'ByBinaryRegr')
                    ...
                    elseif ismember(this.Method,{'PartitionedModel' 'PartitionedEnsemble' 'PartitionedLinear'})
                ...
                switch learner.Method
                    ...
                    case 'Linear'
                        if strcmp(this.Method,'PartitionedLinear')
                            this.DefaultScore = 0;
                        else
                            error(message('stats:classreg:learning:modelparams:EnsembleParams:fillDefaultParams:MethodNotAllowedForEnsembleLearning',...
                                learner.Method));
