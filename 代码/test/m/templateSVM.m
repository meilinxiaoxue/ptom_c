...
%                                 1000
%       'ClipAlphas'            - Logical scalar. If true,
%                                 the alpha coefficients near zero will be
%                                 set to zero and the alpha coefficients
%                                 near the box constraint will be set to
%                                 the box constraint at each iteration.
%                                 This parameter can affect SMO and ISDA
...
%       'RemoveDuplicates'      - Logical scalar. If true,
%                                 duplicate observations will be replaced
%                                 in the training data with a single
%                                 observation with weight equal to the
%                                 cumulative weight of these duplicates.
%                                 Setting this parameter to true can speed
%                                 up training considerably for data with
%                                 many duplicate observations. Default:
%                                 false
