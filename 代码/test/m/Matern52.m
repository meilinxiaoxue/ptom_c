...
%Matern52 A class that defines the Matern 5/2 kernel.
%
%   Matern52 properties:
...
%   Copyright 2014-2015 The MathWorks, Inc.
    ...
    properties(GetAccess=public,SetAccess=protected)
        ...
        %   function. The Matern52 kernel can be parameterized in terms of
        ...
        %   Does not apply to the Matern52 kernel.
        CustomFcn = [];                
    end
    ...
    methods(Static)        
        ...
        %makeFromTheta - Make Matern52 kernel function.
        %   this = makeFromTheta(Theta) takes a 2-by-1 vector Theta and
        %   returns a Matern52 kernel object. Theta is related to length
    ...
    methods      
        ...
        %
        %   For Matern 5/2 kernel params struct has these fields:
        %
        %       Name                 = 'Matern52'
    ...
    methods
        ...
        %   at a higher memory cost.
            ...
            if usecache
                ...
                % take the square root for Matern52 evaluation.
        ...
        %   o KNM = N-by-M kernel matrix K(XN,XM | Theta).        
            ...
            function KNM = f(XN,XM)                
                % 2.1 Compute sqrt(5)*D/sigmaL where D is the Euclidean distance matrix.
