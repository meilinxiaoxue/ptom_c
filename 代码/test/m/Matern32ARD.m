...
%Matern32ARD A class that defines the Matern 3/2 kernel with a separate length scale per predictor.
%
%   Matern32ARD properties:
...
%   Copyright 2014-2015 The MathWorks, Inc.
    ...
    properties(GetAccess=public,SetAccess=protected)
        ...
        %   function. The Matern32ARD kernel can be parameterized
        ...
        %   Does not apply to the Matern32ARD kernel.
        CustomFcn = [];          
    end
    ...
    methods      
        ...
        %
        %   As an example, for Matern32ARD with 2 predictors,
    ...
    methods
        ...
        %   KNM and DKNM at a higher memory cost.        
            ...
            % Force D2 to be >= 0 for the Matern32ARD kernel.
            ...
            % d = number of predictors or variables
                ...
                % 3.3 Get DKNM if needed. Precompute KNM./(1 + D) that 
                % appears in the expression for derivatives and save in D.                
                if nargout < 2
                    return;
                end
                D = KNM./(1 + D);
        ...
        %   o KNM = N-by-M kernel matrix K(XN,XM | Theta).        
            ...
            % calcDistance to be >= 0 for the Matern32ARD kernel.
            d        = length(theta) - 1;            
            sigmaL   = exp(theta(1:d));
            sigmaF   = exp(theta(d+1));            
            tiny     = this.Tiny;
