...
%                    string array or cell array of strings.  Each string 
%                    can be 'normal', 'box', 'triangle', or 'epanechnikov'.
%                    If Kernel is acell array, then the only elements used 
%                    are those for which 'DistributionNames' is 'kernel'.
%                   Default: 'normal'
...
%                    1-by-P string/cell array of these values:
