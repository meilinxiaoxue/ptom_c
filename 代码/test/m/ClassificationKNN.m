...
%                     %representing the class labels for nearest neighbors             
    ...
    methods
        ...
        %   [LABEL,POSTERIOR,COST]=PREDICT(KNN,X) returns predicted class labels
        %   LABEL, posterior probabilities POSTERIOR and misclassification costs
        %   COST for KNN and predictors X. X must be a table if KNN was originally
        %   trained on a table, or a numeric matrix if KNN was originally trained
        ...
        %   where P is the number of predictors used for training. Classification
        ...
        %   and K classes, where N is the number of rows in X. COST is an N-by-K
