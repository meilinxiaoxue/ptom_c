...
% Gradient of fun is optionally computed using finite differences. The
% function fun is assumed to be smooth.
%
...
%                       same effect.
%
%          'GradObj'  - Either 'on' or 'off'. If 'on', it is assumed that
%                       fun can return gradient information like this:
%
%                       [f,gradf] = fun(theta)
%
%                       Default is 'off'.
%
%       Gamma     A real positive scalar specifying the initial Hessian 
%                 approximation as the value of 'Gamma' times the identity 
%                 matrix. Default is [] indicating that 'Gamma' must be 
%                 determined automatically based on the diagonal Hessian
%                 elements at the initial point.
%
%       InitialStepSize      
%                 A real positive scalar specifying the norm of first step.
%                 If 'InitialStepSize' is supplied then 'Gamma' is
%                 calculated based on 'InitialStepSize' and the value
%                 supplied for 'Gamma' is ignored. Default is [] indicating
%                 that the value in 'Gamma' is used.
%
%   OUTPUTS:
%
...
%   Copyright 2012-2017 The MathWorks, Inc.
    ...
    %% Handle input args.        
        ...
        % (2) Extract optimization options.
            ...
            % (7) Do we have gradient information?
    ...
    %% Initialize control variables for trust region iterations.  
        ...
        % (4) Initial positive definite Hessian approximation.
...
% |=====================================================================================================|
% |        0 |  -4.44935e+01 |   4.679e+02 |   4.716e-01 |   CONV  |   2.334e+00 |   1.732e+00 |   YES  |
% |        1 |  -4.44935e+01 |   4.679e+02 |   1.732e+00 |  EXACT  |  -5.091e-01 |   1.732e+00 |    NO  |
% |        2 |  -1.62889e+02 |   9.606e+01 |   8.660e-01 |  BNDRY  |   4.188e-01 |   8.660e-01 |   YES  |
% |        3 |  -1.64574e+02 |   6.105e+01 |   2.075e-02 |   CONV  |   1.654e+00 |   8.660e-01 |   YES  |
% |        4 |  -1.65853e+02 |   1.880e+01 |   4.136e-02 |   CONV  |   9.594e-01 |   8.660e-01 |   YES  |
% |        5 |  -1.66595e+02 |   1.702e+01 |   3.781e-02 |   CONV  |   1.897e+00 |   8.660e-01 |   YES  |
% |        6 |  -1.68402e+02 |   1.537e+01 |   3.543e-01 |   CONV  |   5.589e-01 |   8.660e-01 |   YES  |
% |        7 |  -1.68961e+02 |   5.887e+00 |   1.673e-01 |   CONV  |   4.060e-01 |   8.660e-01 |   YES  |
% |        8 |  -1.69149e+02 |   1.945e+00 |   4.564e-02 |   CONV  |   1.340e+00 |   8.660e-01 |   YES  |
...
end % end of validateGamma.

%=== validateInitialStepSize
...
end % end of validateInitialStepSize.
