...
%       ExpandedPredictorNames - Names of expanded predictors used for this discriminant.
...
%   Copyright 2011-2017 The MathWorks, Inc.
    ...
    methods(Hidden)
        function this = ClassificationDiscriminant(X,Y,W,modelParams,...
            ...
            if contains(discrimType,'linear','IgnoreCase',true)
                isquadratic = false;
            else
                isquadratic = true;
            end
            
            % All classes must have weights
            classHasWeight = ...
            ...
            if any(any(~isfinite(this.PrivX)))
            ...
            % Make the implementation object. Class means and factorizations of
            % the covariance matrices match ClassSummary.NonzeroProbClasses.
            if isquadratic
