classdef FullCholeskyCovariance <classreg .regr .lmeutils .covmats .CovarianceMatrix 
...
function this =FullCholeskyCovariance (dimension ,varargin )
...
type =classreg .regr .lmeutils .covmats .CovarianceMatrix .TYPE_FULLCHOLESKY ; 
end
